...
const { validateInviteSignin, inviteSignin } = require('./handlers/inviteSignin');
...
router.post('/invite-signin', authorize(roles.Admin), validateInviteSignin, inviteSignin);
